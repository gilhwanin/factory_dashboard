...
"}")
        ...
        self.btn_prev_2 = QtWidgets.QPushButton(self.frame_6)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        font.setFamily("Noto Sans KR Medium")
        font.setPointSize(18)
        self.btn_prev_2.setFont(font)
        self.btn_prev_2.setObjectName("btn_prev_2")
        self.horizontalLayout_8.addWidget(self.btn_prev_2)
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "코스트코"))
        ...
        self.btn_prev_2.setText(_translate("Form", "자동전환"))
