...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_retailer = QtWidgets.QLabel(self.frame_10)
        ...
        self.label_retailer.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.label_retailer.setIndent(-1)
        self.label_retailer.setObjectName("label_retailer")
        self.horizontalLayout_13.addWidget(self.label_retailer)
        self.pagination = QtWidgets.QFrame(self.frame_10)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pagination.sizePolicy().hasHeightForWidth())
        self.pagination.setSizePolicy(sizePolicy)
        self.pagination.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.pagination.setFrameShadow(QtWidgets.QFrame.Raised)
        self.pagination.setObjectName("pagination")
        self.horizontalLayout_12 = QtWidgets.QHBoxLayout(self.pagination)
        self.horizontalLayout_12.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_12.setObjectName("horizontalLayout_12")
        self.btn_left = QtWidgets.QPushButton(self.pagination)
        ...
        self.btn_left.setMinimumSize(QtCore.QSize(40, 0))
        self.btn_left.setMaximumSize(QtCore.QSize(40, 16777215))
        font = QtGui.QFont()
        font.setFamily("Noto Sans KR Medium")
        font.setPointSize(18)
        self.btn_left.setFont(font)
        self.btn_left.setObjectName("btn_left")
        self.horizontalLayout_12.addWidget(self.btn_left)
        self.page_label = QtWidgets.QLabel(self.pagination)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_12.addWidget(self.page_label)
        self.btn_right = QtWidgets.QPushButton(self.pagination)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_right.sizePolicy().hasHeightForWidth())
        self.btn_right.setSizePolicy(sizePolicy)
        self.btn_right.setMinimumSize(QtCore.QSize(40, 0))
        self.btn_right.setMaximumSize(QtCore.QSize(40, 16777215))
        font = QtGui.QFont()
        font.setFamily("Noto Sans KR Medium")
        font.setPointSize(18)
        self.btn_right.setFont(font)
        self.btn_right.setObjectName("btn_right")
        self.horizontalLayout_12.addWidget(self.btn_right)
        self.horizontalLayout_13.addWidget(self.pagination)
        self.horizontalLayout_11.addWidget(self.frame_10)
        self.btn_renew = QtWidgets.QPushButton(self.frame_9)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_renew.sizePolicy().hasHeightForWidth())
        self.btn_renew.setSizePolicy(sizePolicy)
        self.btn_renew.setMinimumSize(QtCore.QSize(120, 0))
        self.btn_renew.setMaximumSize(QtCore.QSize(240, 16777215))
        font = QtGui.QFont()
        font.setFamily("Noto Sans KR Medium")
        font.setPointSize(14)
        self.btn_renew.setFont(font)
        self.btn_renew.setStyleSheet("QPushButton {\n"
...
"}")
        ...
        self.horizontalLayout_11.addWidget(self.btn_renew)
        self.btn_view = QtWidgets.QPushButton(self.frame_9)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_11.addWidget(self.btn_view)
        ...
        self.horizontalLayout_10.setSpacing(24)
...
"}")
        ...
        self.horizontalLayout_10.addWidget(self.btn_admin)
        self.ml_check = QtWidgets.QCheckBox(self.frame_8)
        font = QtGui.QFont()
        font.setFamily("Noto Sans KR Medium")
        font.setPointSize(14)
        self.ml_check.setFont(font)
        self.ml_check.setObjectName("ml_check")
        self.horizontalLayout_10.addWidget(self.ml_check)
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.page_label.setText(_translate("Form", "1/2"))
        self.btn_right.setText(_translate("Form", "▶"))
        self.btn_renew.setText(_translate("Form", "발주량/출고량 갱신"))
        ...
        self.ml_check.setText(_translate("Form", "물류 UI"))
