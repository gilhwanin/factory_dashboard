...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.dateEdit.setMinimumSize(QtCore.QSize(180, 0))
        font = QtGui.QFont()
        font.setFamily("Noto Sans KR Medium")
        font.setPointSize(14)
...
"}")
        ...
        self.btn_prev_3 = QtWidgets.QPushButton(self.view_frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_prev_3.sizePolicy().hasHeightForWidth())
        self.btn_prev_3.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Noto Sans KR Medium")
        font.setPointSize(18)
        self.btn_prev_3.setFont(font)
        self.btn_prev_3.setObjectName("btn_prev_3")
        self.horizontalLayout_6.addWidget(self.btn_prev_3)
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.btn_prev_3.setText(_translate("Form", "행 숨기기"))
